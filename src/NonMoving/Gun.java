...
public class Gun extends Item {
    ...
    public Gun(int x, int y, int width, int height, java.awt.Image image) {
        _xCoord = x;
        _yCoord = y;
        _width = width;
        _height = height;
    ...
    public void load(int centerOfMaxX, int centerOfManY) {
        ...
        _heightOf0DegreeTriangle = Math.abs(centerOfManY - getYCoord() - getHeight() / 2);
    ...
    public Bullet use(int centerOfManX, int centerOfManY) {
        ...
        double newWidth = Math.sqrt(Math.pow(_hypotenuseOf0DegreeTriangle, 2.0D) -
/*  54 */       Math.pow(newHeight, 2.0D));
